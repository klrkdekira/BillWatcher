...
class BaseDownloader:
    ...
    async def download_bill(
        self, path: str, follow_redirects: bool = True
    ) -> AsyncIterator[bytes]:
        ...
        async with httpx.AsyncClient(
            ...
            resp = await client.send(req, follow_redirects=follow_redirects)
...
class ArchiveDownloader(BaseDownloader):
    ...
    async def download_archive_index(
    ...
    async def download_archive_year(
        self, year: int, follow_redirects: bool = True
    ) -> AsyncIterator[bytes]:
        self.cookies.load(ignore_discard=True, ignore_expires=True)
